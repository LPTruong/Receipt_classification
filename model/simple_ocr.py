...
from variable import _dir, segmenation_blur_params ,segmenation_erode_params, _dir_logo
...
logo_phuclong1 = cv2.imread(_dir_logo + "phuclong.jpg")
logo_phuclong1 = cv2.resize(logo_phuclong1, logo_size)
logo_phuclong2 = cv2.imread(_dir_logo + "phuclong2.JPG")
logo_phuclong2 = cv2.resize(logo_phuclong2, logo_size)
logo_starbuck = cv2.imread(_dir_logo + "starbuck.jpg")
